...
$msg="This email  associated with another account";
    ...
    $query=mysqli_query($con, "insert into tbladmin(FullName, MobileNumber, Email,  Password) value('$fname', '$mobno', '$email', '$password' )");
    if ($query) {
...
<head>
	...
	<title>Savings and Expense Management - Signup</title>
...
<body>
	<div class="row">
			<h2 align="center">Savings and Expense Management</h2>
	<hr />
